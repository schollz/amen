...
local breaker_option_controls={
  ...
  function dial_effect(k,d)
    ...
    elseif breaker_option_controls[sel1]~=nil then
      ...
      params:delta(voice..breaker_option_controls[sel1][k-1].param,d)
    else
      ...
      for i=1,2 do
        ...
        if sel~="" then
          ...
          if breaker_option_controls[sel]~=nil then
            local s=""
            for j=1,2 do
              s=s..breaker_option_controls[sel][j].pre
              s=s..params:get(voice..breaker_option_controls[sel][j].param)
              s=s..breaker_option_controls[sel][j].post
              s=s.."  "
            end
            box_text(70+41,1,s)
          end
